...
public class ListObjects {
    public static void main(String[] args) {
        ...
        ArrayList<String> list = new ArrayList<>();//reference is ArrayList
        List<String> list1 = new ArrayList<>();//reference is Interface and object side is ArrayList
                                               //
        list1.add("a");//0 index
        list1.add("b");//1 index
        list1.add("c");
